...
public class PurchaseTimingsDto implements Serializable {
    ...
    private boolean isActive = true; // ✅ New Field

    public PurchaseTimingsDto() {}

    public PurchaseTimingsDto(Long id, String userName, String phoneNumber, String item, double amount,
                               String location, LocalDateTime purchaseTime, boolean isActive) {
        this.id = id;
